...
- [Frontend Documentation](#frontend-documentation)
  ...
  - [Authentication Interceptor Documentation](#authentication-interceptor-documentation)
  - [Frontend Components & Other Features](#frontend-components--other-features)
    - [Mixin Elements](#mixin-elements)
    - [Layout Elements](#layout-elements)
    - [Dynamic Results Elements](#dynamic-results-elements)
    - [Auth Guards](#auth-guards)
    - [Global Error handling and Routable Exceptions](#global-error-handling-and-routable-exceptions)
    - [Child Routes and Layout Pages](#child-routes-and-layout-pages)
