    ...
    bind(request: Request): ActionRequest {
        return {
            dto: {
                ...
                startTime: parsers.parseDateOrElse(request.body.startTime, "Invalid Date"),
                endTime: request.body.endTime == null ? null : parsers.parseDateOrElse(request.body.endTime, "Invalid Date"),
