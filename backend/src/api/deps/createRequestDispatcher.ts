...
function createRequestDispatcher() {
    ...
    requestDispatcher.registerHandler(DeletePlayerCommand, new DeletePlayerCommandHandler({ playerRepository: playerRepository, teamRepository: teamRepository, playerExistsValidator: playerExistsValidator }));
    ...
    // Users
    requestDispatcher.registerHandler(RegisterUserCommand, new RegisterUserCommandHandler({ passwordHasher: passwordHasher, userRepository: userRepository, userExistsValidator: userExistsValidator }));
    ...
    // Matches
    requestDispatcher.registerHandler(CreateMatchCommand, new CreateMatchCommandHandler({ matchRepository: matchRepository, teamExistsValidator: teamExistsValidator }));
    ...
    requestDispatcher.registerHandler(RecordGoalCommand, new RecordGoalCommandHandler({ matchRepository: matchRepository, teamExistsValidator: teamExistsValidator, matchExistsValidator: matchExistsValidator }));
